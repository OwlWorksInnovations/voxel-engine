...
No, its nowhere near finished I plan on implementing a ECS (Entity Component System) and using ImGui to control the editor. I still have no idea on how I would approach building the game from the engine, collision detection, terrain generation, model loading into voxels, etc.
