...
![Gif of engine](https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExbnNmNmFucmw4NjQ1c3JwNHhvZjdqMnAzNWZ1ZWI2b3c0MGN1c2ZzbSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/0ek2RpHeZiB8HXVGLf/giphy.gif)
...
No, its nowhere near finished I plan on implementing a ECS (Entity Control System) and using ImGui to control the editor. I still have no idea on how I would approach building the game from the engine, collision detection, terrain generation, model loading into voxels, etc.
